...
namespace linuxcommon{
	...
	std::string get_line_with_delim(std::string filename, std::string line,std::string delim);/** This function is used for files like *.desktop files to get a value*/
	std::string get_line_with_delim_after_header(std::string header,std::string filename, std::string line,std::string delim);/** This function is used for files like *.desktop files to get a value*/
    ...
    bool set_line_with_equal(std::string filename, std::string line, std::string value);
	bool set_line_with_delim(std::string filename, std::string line, std::string value, std::string delim);
    bool set_line_with_equal_after_header(std::string header, std::string filename, std::string line, std::string value);
